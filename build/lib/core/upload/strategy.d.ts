...
export declare type UploadStrategyLabel = string;
export declare type UploadStrategyObject = {
    label: UploadStrategyLabel;
    params: any;
};
export declare type UploadStrategyFunction = (bucketId: string, opts: any, strategyObj: UploadStrategyObject) => ActionState;
