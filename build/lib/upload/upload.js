 ...
 */
function upload(config, bucketId, fileMeta, params, logger, actionState) {
    return __awaiter(this, void 0, void 0, function () {
        var file, uploadResponses, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    file = new FileObjectUpload_1.FileObjectUpload(config, fileMeta, bucketId, logger);
                    actionState.on(constants_1.UPLOAD_CANCELLED, function () { file.emit(constants_1.UPLOAD_CANCELLED); });
                ...
                case 6:
                    ...
                    if (file && file.isAborted()) {
                        return [2 /*return*/, params.finishedCallback(new Error('Process killed by user'), null)];
                    }
                    params.finishedCallback(err_1, null);
                    return [3 /*break*/, 7];
